...
lab<-df_g %>% 
  mutate(label=
           ifelse(year=="2008" & iso3c=="CHN","China Earthquake 2008",
           ifelse(year=="2010" & iso3c=="HTI","Haiti Earthquake\n 2010",
           ifelse(year=="2006" & iso3c=="SDN","Sudan Floods \n2006",
...
p+geom_text_repel(data=lab,aes(x = Norm_scaled, y = aid_scaled, label=label,force=8))+
...
ggsave("./plots/labelled_scatter_20240313.png", width=8,height=5)
...
ggplot(df_t, aes(x = year, fill = GlobSol)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
   ...
   scale_fill_brewer(palette="Set1")# Tilting the x-axis labels by 45 degrees
...
ggplot(df_proportions, aes(x = year, y = proportion, fill = factor(GlobSol))) +
  ...
  scale_fill_brewer(palette="Set1", name = "GlobSol") +  # Manually set colors for each category
    theme(axis.text.x = element_text(angle = 45, hjust = 1),
