...
```
NB: devo calcolare il numero di paesi che fa dichiarazioni, non il numero di dichiarazioni!
...
#reshape
df_ICWES_g2g_dis_m<-reshape2::dcast(df_ICWES_g2g_dis_m, iso3c_target+year~event_text)
...
names(df_ICWES_g2g_dis_m) <- column_names_mapping[names(df_ICWES_g2g_dis_m)]

#list variables 
List<- colnames(df_ICWES_g2g_dis_m)[colnames(df_ICWES_g2g_dis_m) %!in% c("iso3c", "year")]

# assign 0s
df_ICWES_g2g_dis_m<-Nas_to_0(df_ICWES_g2g_dis_m,List)

## sum
df_ICWES_g2g_dis_m$NormAgr<-df_ICWES_g2g_dis_m$cooperate_dis+
                            df_ICWES_g2g_dis_m$econo_dis+
                            df_ICWES_g2g_dis_m$material_aid_dis+
                            df_ICWES_g2g_dis_m$economic_aid_dis+
                            df_ICWES_g2g_dis_m$human_aid_dis+
                            df_ICWES_g2g_dis_m$material_coop_dis

# assign NAs

## collapse at country year level
