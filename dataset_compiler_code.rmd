...
download_create_folder_and_unzip <- function(url, destination_folder) {
  # Download the zip file
  download.file(url, destfile = "temp.zip", mode = "wb")
  
  # Unzip the downloaded file
  unzip("temp.zip", exdir = destination_folder)
...
# Example usage
url <- "https://github.com/AidData-WM/public_datasets/releases/download/v3.0/AidDataCore_ResearchRelease_Level1_v3.0.zip"
...
```
## adding title just to check all is ok
