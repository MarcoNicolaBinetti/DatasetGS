...
EM_dat<-subset(EM_dat,EM_dat$DisasterGroup=="Natural")
...
## in case we want to add the technological disasters
...
# create dummy variable to count events
...
## sum
df_ICWES_g2g_dis_y$NormAgr <- rowSums(df_ICWES_g2g_dis_m[c("cooperate_dis",
                                                           "econo_dis",
                                                           "material_aid_dis",
                                                           "economic_aid_dis",
                                                           "human_aid_dis",
