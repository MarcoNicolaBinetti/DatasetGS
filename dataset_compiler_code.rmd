...
# df_ICWES<-subset(df_ICWES, df_ICWES$iso3c %in%List_cntrs_iso3c)
# 
# 
# URL_df<-paste0("C:/Users/marco/Desktop/prediction competition/df_ICWES.rds")
# 
# #saving icews df
...
EM_dat_y[List] <- lapply(EM_dat_y[List], function(x) ifelse(x > 0, 1, 0))

## rename variables
# Rename selected variables
names(EM_dat_y)[names(EM_dat_y) %in% List] <- sub("_n_m$", "_dummy", names(EM_dat_y)[names(EM_dat_y) %in% List])
