...
# Rearrange columns
df_HOD_Dec_2021 <- df_HOD_Dec_2021[, c("name", "iso3c", setdiff(names(df_HOD_Dec_2021), c("name", "iso3c")))]
df_HOD_Dec_2021 <- df_HOD_Dec_2021[, c("name", "c_name", setdiff(names(df_HOD_Dec_2021), c("name", "c_name")))]
...
df_HOD_cy<-subset(df_HOD_cy, df_HOD_cy$year>1990)
...
for (k in 1994:2021){
 ...
 year<-paste0("",k,"")
 File<-paste0("C:/Users/marco/Desktop/DFGlobalLab/UN Comtrade/TradeData_",year,".csv")
