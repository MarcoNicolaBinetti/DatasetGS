...
```{r}
## import  dataset
Aiddata<- read.csv("C:/Users/marco/Nextcloud/Global Solidarity/Paper on Natural Disasters/STATA dofile/Replication code for The Politics of International Solidarity/AidDataCoreDonorRecipientYearPurpose_ResearchRelease_Level1_v3.0.csv")
...
df_Aiddata_sectoral <- df_Aiddata_sectoral %>% 
  ...
  dplyr::summarise(
    commitment_tot = sum(commitment_amount_usd_constant_sum, na.rm = TRUE),
    .groups = "drop"
  )
...
# Save or display the final plot
ggsave("C:/Users/marco/Nextcloud/Global Solidarity/Paper on Natural Disasters/STATA dofile/Replication code for The Politics of International Solidarity/Figure1A.png", final_plot, width = 8, height = 6)
print(final_plot)
