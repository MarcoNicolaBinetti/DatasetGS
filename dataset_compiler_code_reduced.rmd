...
path<-"C:/Users/krogers/Nextcloud/Global Solidarity/Compiled"
...
## create path
folder_path <- file.path(desktop_path, main_folder_name,sub_folder_name,"globsol_20251125_df50k.rds")
## save file
saveRDS(df50k,folder_path)

## create path
folder_path <- file.path(desktop_path, main_folder_name,sub_folder_name,"globsol_20251125_df5k.rds")
## save file
saveRDS(df5k,folder_path)

## create path
folder_path <- file.path(desktop_path, main_folder_name,sub_folder_name,"globsol_20251125_df100k.rds")
## save file
saveRDS(df100k,folder_path)
