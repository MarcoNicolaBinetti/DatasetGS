...
userpath<-("C:/Users/krogers/") #for Nextcloud
...
complete_formula <-gen_formula(dependent_var,Vars)
# Estimate the multinomial logistic regression model
multinom_model4 <- multinom(complete_formula, data = full_model_df)

Vars<-c(main_indip,econo,pol,cof_deve)
# Create the complete formula
complete_formula <-gen_formula(dependent_var,Vars)
# Estimate the multinomial logistic regression model
multinom_model4b <- multinom(complete_formula, data = full_model_df)
...
complete_formula <-gen_formula(dependent_var,Vars)
# Estimate the multinomial logistic regression model
multinom_model5 <- multinom(complete_formula, data = full_model_df)
...
complete_formula <-gen_formula(dependent_var,Vars)
# Estimate the multinomial logistic regression model
multinom_model6 <- multinom(complete_formula, data = full_model_df)
...
complete_formula <-gen_formula(dependent_var,Vars) 
# Estimate the multinomial logistic regression model
multinom_model7 <- multinom(complete_formula, data = full_model_df)
...
ame$term<-ifelse(ame$term=="gdp_per_cap_ppp_lag_1","Per capita GDP ($US hundreds)",
...
ggplot(ame, aes(x=estimate,y=term,colour=group))+ 
  ...
  ylab("Independent variables")+xlab("Average marginal effect")+
   scale_colour_manual(values=globsol_colours,name="Global Solidarity outcome",
